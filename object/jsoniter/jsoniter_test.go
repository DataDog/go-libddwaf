...
type testCase struct {
	name                  string
	jsonInput             string
	encoderSetup          func(e *object.EncoderConfig) // For configuring limits
	expectOutput          any
...
func verifyTestCases(t *testing.T, pinner *runtime.Pinner, tc testCase, initiallyTruncated bool, checkOutput bool) {
	...
	config := object.NewUnlimitedEncoderConfig(pinner)

	if tc.encoderSetup != nil {
		tc.encoderSetup(&config)
	}

	wafObj := &object.WAFObject{}
...
func TestJSONEncode_Arrays(t *testing.T) {
	...
	testCases := []testCase{
		...
		},
		{
			...
			encoderSetup: func(e *object.EncoderConfig) {
		...
		},
		{
			...
			truncations:  map[object.TruncationReason][]int{object.ContainerSize: {6, 5}},
		},
		{
			name:      "array depth",
			jsonInput: `[1, 2, [4, 5]]`, // Depth 3 for the innermost array containing 1
			encoderSetup: func(e *object.EncoderConfig) {
				e.MaxContainerDepth = 1
			},
		...
		},
		{
			...
			encoderSetup: func(e *object.EncoderConfig) {
				e.MaxContainerDepth = 2
			},
			expectOutput: []any{[]any{}},
			truncations:  map[object.TruncationReason][]int{object.ContainerDepth: {3}},
		},
		{
		...
		},
		{
			...
			encoderSetup: func(e *object.EncoderConfig) {
				e.MaxContainerDepth = 3 // Allows [1], [2, ...], [3, "deep"]. "deep" string is at depth 3 with its array.
			},
		...
		},
		{
			...
			jsonInput: `[1, [2, [3, "deep"]]]`,
			encoderSetup: func(e *object.EncoderConfig) {
				e.MaxContainerDepth = 2 // Allows [1], [2, ...]. The array [3, "deep"] is at depth 3.
			},
...
func TestJSONEncode_Objects(t *testing.T) {
	...
	testCases := []testCase{
		...
		},
		{
			...
			truncations:  map[object.TruncationReason][]int{object.ContainerSize: {5, 6}},
		},
		{
			...
			truncations:  map[object.TruncationReason][]int{object.StringLength: {15, 8}}, // Lengths of "verylongkeyname" and "shortkey"
		},
		{
			...
			truncations:  map[object.TruncationReason][]int{object.StringLength: {19}}, // Length of "verylongstringvalue"
		},
		{
...
func TestJSONEncode_MalformedInput(t *testing.T) {
	...
	testCases := []sharedTestCase{
		...
		},
		{
			...
			encoderSetup: func(e *object.EncoderConfig) {
				e.MaxStringLength = 10
			},
			truncatedTestCase: testCase{
				expectOutput: "thisisaver",
				truncations:  map[object.TruncationReason][]int{object.StringLength: {40}}, // Length of original string
			},
			notTruncatedTestCase: testCase{
				expectOutput: "thisisaver",
				truncations:  map[object.TruncationReason][]int{object.StringLength: {40}},
			},
		},
		{
...
func sortTruncations(truncations map[object.TruncationReason][]int) map[object.TruncationReason][]int {
	if truncations == nil {
		return nil
	}
